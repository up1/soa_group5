$(document).ready(function() {
    ...
    if(cinema_id == '[]' && movie_id != '[]') {
        link = "http://128.199.122.153:9003/showfrommovie?movie=" + movie_id;

    } else {
        if(cinema_id != '[]' && movie_id == '[]') {
            link =  "http://128.199.122.153:9003/showfromcinema?cinema=" + cinema_id;


        } else {
            if(cinema_id != '[]' && movie_id != '[]') {
                link = "http://128.199.122.153:9003/showfromall?movie=" + movie_id + "&cinema=" + cinema_id;
